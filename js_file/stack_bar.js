function StackedBarChart(data, {
    ...
    svg.append("text")
        ...
        .attr("fill", "currentColor")
        .attr("text-anchor", "start")
        .text("Stack bar plot of total count for each category of Yelp in US");
  ...
  d3.json('./data/stack_bar.json').then(result => {
    ...
    chart = StackedBarChart(result, {
      ...
      yLabel: "Count of each Yelp category",
      xLabel:"States",
      width:1200,
      height: 700,
    });
